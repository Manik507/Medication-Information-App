...
import { Search, Pill, ChevronRight, Loader, Sparkles } from 'lucide-react';
...
export default function SearchMedicine() {
  ...
  async function handleSearch(e) {
    ...
    try {
      ...
      if (!data.results?.length) toast('No results found for that medicine name', { icon: '🔍', style: { background: 'var(--glass-bg)', color: 'var(--text-primary)', backdropFilter: 'blur(12px)', border: '1px solid var(--glass-border)' }});
    } catch {
